/**
  ...
  *
  *  El documento permite "broadcast/multicast UDP" para el anuncio de
  *  presencia dentro de la propia subred. Esta implementacion usa
...
class Descubrimiento {
   ...
   public:
      ...
      // NOTA: como el documento identifica a TODOS los servidores de bodega
      // con el mismo id generico "SERV" (sin numerar), puede haber varias
      // instancias fisicas anunciandose con el mismo id (para la prueba de
      // "al menos dos bodegas disponibles"). Por eso la tabla guarda una
      // LISTA de peers por id, no uno solo. El mensaje DEATH de este
